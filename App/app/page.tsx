...
export default function Home() {
  ...
  const NAV_CARDS = [
    { 
      ...
      description: "Structural work and heavy construction"
    },
    { 
      id: "Installations", 
      title: "Installations", 
        ...
        <section className="w-full lg:w-[35%] lg:flex-none p-8 sm:p-10 xl:p-20 flex flex-col justify-center relative overflow-hidden border-t lg:border-t-0 lg:border-r border-white/10 bg-slate-950 shrink-0">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 gap-4 sm:gap-6 max-w-2xl lg:max-w-md mx-auto lg:mx-0">
              <Tooltip content="Every professional is background checked">
                <div className="flex items-center lg:items-start gap-4 p-4 sm:p-5 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm transition-transform hover:scale-105 duration-300 cursor-help">
              ...
              <Tooltip content="Watch your construction site in real-time">
                <div className="flex items-center lg:items-start gap-4 p-4 sm:p-5 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm transition-transform hover:scale-105 duration-300 cursor-help">
              ...
              <Tooltip content="Locked-in quotes with no surprises">
                <div className="flex items-center lg:items-start gap-4 p-4 sm:p-5 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm transition-transform hover:scale-105 duration-300 cursor-help">
        ...
        <section className="flex-1 flex flex-col items-center justify-center p-4 sm:p-6 bg-slate-50 relative lg:min-h-0 lg:overflow-y-auto">
          <div className="w-full max-w-md lg:max-w-3xl relative z-10 py-8 lg:py-0">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-6">
              {NAV_CARDS.map((card) => (
                <Tooltip key={card.id} content={card.description}>
                  <button
                    onClick={() => navigateTo(card.id)}
                    className={`group relative flex flex-col w-full justify-between p-4 sm:p-6 h-40 sm:h-52 bg-white border border-slate-200 rounded-[24px] sm:rounded-[40px] transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 hover:scale-[1.03] ${card.color} hover:border-transparent overflow-hidden`}
                  >
