...
export default function CreateJobDetails({ onClose, onSubmit }: DetailsProps) {
        ...
        <form onSubmit={handleSubmit} className="px-8 pb-10 space-y-4">
          <div className="relative group">
            ...
            <input
              ...
              className="w-full bg-slate-50 border-2 border-slate-900 rounded-2xl py-4 pl-14 pr-6 text-[10px] font-black uppercase placeholder:text-slate-400 focus:outline-none focus:bg-white focus:border-yellow-400 transition-all"
            />
          </div>
          ...
          <div className="relative group">
            ...
            <textarea
              ...
              className="w-full bg-slate-50 border-2 border-slate-900 rounded-[24px] py-4 pl-14 pr-6 text-[10px] font-black uppercase placeholder:text-slate-400 focus:outline-none focus:bg-white focus:border-yellow-400 transition-all min-h-[100px] resize-none"
            />
          </div>

          <button
            type="submit"
            className="w-full bg-slate-900 text-white py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-yellow-400 hover:text-black transition-all active:scale-95 shadow-lg"
          >
            Review Summary
          </button>
        </form>

        <button onClick={onClose} className="absolute top-6 right-6 p-2 text-slate-400 hover:text-slate-900 transition-all">
          <X size={20} />
        </button>
      </div>
    </div>
