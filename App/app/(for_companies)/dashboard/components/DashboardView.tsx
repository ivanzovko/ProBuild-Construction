    ...
    <div className="min-h-screen bg-slate-50 flex flex-col lg:flex-row relative text-slate-900">
      ...
      <main className="flex-1 p-4 md:p-8 lg:p-12 overflow-y-auto h-[calc(100vh-60px)] lg:h-screen">
        <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-12">
          ...
          <button className="w-full sm:w-auto bg-slate-900 text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-[0.2em] hover:bg-yellow-400 hover:text-black transition-all flex items-center justify-center gap-2 shadow-xl active:scale-95">
        ...
        <section className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <button onClick={fetchProjects} className="text-[9px] font-black uppercase text-slate-400 hover:text-yellow-500 tracking-widest transition-colors">Refresh Feed</button>
          </div>
