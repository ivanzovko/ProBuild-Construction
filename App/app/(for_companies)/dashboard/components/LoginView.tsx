...
export default function LoginView({ onLogin }: LoginViewProps) {
  ...
  if (isSuccess) {
    return (
      <section className="w-full h-full flex items-center justify-center p-8 bg-slate-900 animate-in fade-in duration-500">
        <div className="flex flex-col items-center justify-center p-8 text-center max-w-md">
          <div className="bg-green-500 p-5 rounded-full mb-8 shadow-lg shadow-green-500/20">
            <CheckCircle2 size={56} className="text-white" />
          </div>
          <h2 className="text-3xl font-black text-white uppercase italic tracking-tight">Success!</h2>
  ...
  return (
    <div className="flex flex-col lg:flex-row h-full w-full">
      <section className="hidden lg:flex lg:w-1/2 bg-slate-900 text-white p-12 lg:p-24 flex-col justify-center relative overflow-hidden h-full">
      ...
      <section className="w-full lg:w-1/2 h-full flex items-center justify-center p-8 bg-slate-900 lg:bg-slate-50 overflow-y-auto">
        <div className="w-full max-w-md bg-white p-10 md:p-16 rounded-[48px] shadow-2xl border border-slate-100 my-auto">
          <div className="text-center mb-10">
            <div className="inline-flex bg-yellow-100 text-yellow-700 p-4 rounded-3xl mb-4"><Building2 size={32} /></div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="bg-red-50 border border-red-100 p-4 rounded-2xl animate-in shake duration-300">
                <div className="flex items-center justify-between gap-4">
                  ...
                  {errorMsg.includes("client") && (
                    ...
                    >
                      For Clients <ArrowRight size={12} />
                    </Link>
                  )}
                </div>
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative flex items-center group">
                <Mail className="absolute left-6 text-slate-300 group-focus-within:text-yellow-500 transition-colors" size={20} />
                <input 
                  type="email" 
                  value={email}
                  ...
                  className="w-full pl-14 lg:pl-16 pr-8 py-5 bg-slate-50 border-2 border-transparent rounded-[24px] focus:border-yellow-400 focus:bg-white outline-none font-bold transition-all text-slate-900 placeholder:text-slate-300" 
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative flex items-center group">
                <Lock className="absolute left-6 text-slate-300 group-focus-within:text-yellow-500 transition-colors" size={20} />
                <input 
                  type="password" 
                  value={password}
            ...
            <button 
              type="submit"
              disabled={loading}
              className="w-full bg-slate-900 text-white py-5 rounded-[24px] font-black uppercase tracking-[0.2em] text-xs hover:bg-yellow-400 hover:text-black transition-all shadow-xl flex items-center justify-center gap-3 active:scale-[0.98] mt-4"
            >
            ...
            <div className="mt-8 flex flex-col items-center gap-3">
              ...
              <button 
                ...
                className="group flex items-center justify-center gap-2 w-full py-4 rounded-[20px] border-2 border-dashed border-slate-200 hover:border-yellow-400 hover:bg-yellow-50 transition-all"
              >
                {isLogin ? (
                  <>
                    <UserPlus size={18} className="text-slate-400 group-hover:text-yellow-600" />
                  ...
                  <>
                    <LogIn size={18} className="text-slate-400 group-hover:text-yellow-600" />
                    <span className="text-[10px] font-black text-slate-900 group-hover:text-yellow-700 uppercase tracking-widest">
                      Back to login
                    </span>
                  </>
